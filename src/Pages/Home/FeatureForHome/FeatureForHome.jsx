            ...
            <div className="w-full space-y-12 lg:w-1/2 ">
              <div>
                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
                  explore our <br /> top class services
                </h1>
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Unlock the power of digital marketing and reach your target
                    audience like never before. Dive into strategies for social
                    media, SEO, email marketing, and more. Stay ahead in the
                    digital landscape and elevate your marketing game with
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Explore the ever-evolving world of web development. From
                    front-end design to back-end functionality, discover the
                    latest technologies, trends, and best practices. Whether
                    you're a seasoned developer or just getting started, our web
                    development category is your gateway to the digital
                    frontier.
                  </p>
                </div>
              </div>
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Unleash your creativity through the art of graphic design.
                    Get inspired by our collection of design concepts, tips, and
                    tutorials. From branding to illustrations, our graphics
                    design category is your canvas for turning imagination into
                    stunning visuals.
                  </p>
                </div>
              </div>
